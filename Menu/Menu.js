  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          width = _props2.width,
          other = _objectWithoutProperties(_props2, ['autoWidth', 'children', 'desktop', 'disableAutoFocus', 'initiallyKeyboardFocused', 'listStyle', 'maxHeight', 'multiple', 'onItemTouchTap', 'onEscKeyDown', 'selectedMenuItemStyle', 'style', 'value', 'valueLink', 'width']);
