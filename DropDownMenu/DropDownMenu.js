  ...
  _createClass(DropDownMenu, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          value = _props.value,
          other = _objectWithoutProperties(_props, ['animated', 'animation', 'autoWidth', 'children', 'className', 'iconStyle', 'labelStyle', 'listStyle', 'maxHeight', 'menuStyle', 'openImmediately', 'style', 'underlineStyle', 'value']);
